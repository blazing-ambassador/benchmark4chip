"""Architecture-oriented metrics for mediapipe-multitask."""
...
class BenchmarkReport:
    benchmark_id: str = "mediapipe-multitask"
    device: str = "cpu"
