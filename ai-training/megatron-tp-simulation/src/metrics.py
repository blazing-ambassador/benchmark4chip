"""Architecture-oriented metrics for megatron-tp-simulation."""
...
class BenchmarkReport:
    benchmark_id: str = "megatron-tp-simulation"
    device: str = "cpu"
