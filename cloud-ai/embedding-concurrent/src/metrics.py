"""Architecture-oriented metrics for embedding-concurrent."""
...
class BenchmarkReport:
    benchmark_id: str = "embedding-concurrent"
    device: str = "cpu"
