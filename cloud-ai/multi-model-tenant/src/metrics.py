"""Architecture-oriented metrics for multi-model-tenant."""
...
class BenchmarkReport:
    benchmark_id: str = "multi-model-tenant"
    device: str = "cpu"
