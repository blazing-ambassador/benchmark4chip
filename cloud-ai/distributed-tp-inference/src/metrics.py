"""Architecture-oriented metrics for distributed-tp-inference."""
...
class BenchmarkReport:
    benchmark_id: str = "distributed-tp-inference"
    device: str = "cpu"
